	...
	<div class="generic-container sm-container">
		<div class="card">
			...
			<div class="collapse ${section.id != null ? 'show' : ''}"
				id="collapseInput">
				<div class="card-body">
					<form:form action="sections/save" modelAttribute="section" method="POST">
						...
						<div class="clearfix">
							...
							<input type="submit" class="btn btn-primary float-right"
								value="${section.id != null ? 'Actualizare' : 'Salvare' }">
					...
					<table class="table ">
						...
						<tbody>
							<c:forEach var="section" items="${sections}" varStatus="loop">
								...
								<c:url var="update" value="/sections/update">
									<c:param name="Id" value="${section.id}" />
								</c:url>

								<c:url var="delete" value="/sections/delete">
									<c:param name="Id" value="${section.id}" />
								</c:url>
